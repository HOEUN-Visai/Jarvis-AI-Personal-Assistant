...
from jarvis.skills.collection.email import EmailSkills
from jarvis.skills.collection.calendar import CalendarSkills
...
CONTROL_SKILLS = [
    {
        ...
        'tags': 'start, hi, hello, wake up, good morning, good afternoon, good evening',
        'description': 'Enables the assistant (ready to hear command)'
    },

    {
        'func': ActivationSkills.disable_assistant,
        'tags': 'bye, good bye, good night, shut down, exit, termination, sleep',
...
BASIC_SKILLS = [
    ...
    {
        'enable': True,
        'func': EmailSkills.send_email,
        'tags': 'send email, email',
        'description': 'Send an email to a recipient'
    },

    {
        'enable': True,
        'func': EmailSkills.read_emails,
        'tags': 'read emails, check inbox',
        'description': 'Read emails from the inbox'
    },

    {
        'enable': True,
        'func': CalendarSkills.schedule_event,
        'tags': 'schedule event, add event to calendar',
